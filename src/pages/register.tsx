...
import { User, Mail, Lock, Sparkles } from 'lucide-react'; // Solo importamos los íconos básicos de lucide-react que usamos en el formulario
...
const Register: React.FC<RegisterProps> = ({ onSwitchToLogin }) => {
  ...
  const NotificationIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      <g fill="none" fill-rule="evenodd">
        ...
        <path fill="#fff" d="M5 9a7 7 0 0 1 14 0v3.764l1.822 3.644A1.1 1.1 0 0 1 19.838 18h-3.964a4.002 4.002 0 0 1-7.748 0H4.162a1.1 1.1 0 0 1-.984-1.592L5 12.764zm5.268 9a2 2 0 0 0 3.464 0zM12 4a5 5 0 0 0-5 5v3.764a2 2 0 0 1-.211.894L5.619 16h12.763l-1.17-2.342a2 2 0 0 1-.212-.894V9a5 5 0 0 0-5-5" stroke-width="0.5" stroke="#fff"/>
      </g>
    </svg>
  );
  ...
  const NutritionIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      <path fill="#fff" d="M22 18a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4v-2h12zM4 3h10a2 2 0 0 1 2 2v9H8v5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2m0 3v2h2V6zm10 2V6H8v2zM4 10v2h2v-2zm4 0v2h6v-2zm-4 4v2h2v-2z" stroke-width="0.5" stroke="#fff"/>
    </svg>
  );
    ...
    <div className="auth-container">
      ...
      <div className="info-section">
        ...
        <p className="info-description">
          Únete a miles de personas que ya están alcanzando sus metas de fitness con nuestros planes personalizados y seguimiento inteligente.
        </p>
          ...
          <div className="feature-item">
            ...
            <div className="feature-content">
              ...
              <p className="feature-description">
                Crea y sigue rutinas adaptadas a tu nivel y objetivos.
              </p>
            </div>
          </div>
          <div className="feature-item">
            ...
            <div className="feature-content">
              ...
              <p className="feature-description">
                Diseña menús equilibrados que complementen tu entrenamiento.
              </p>
            </div>
          </div>
          <div className="feature-item">
